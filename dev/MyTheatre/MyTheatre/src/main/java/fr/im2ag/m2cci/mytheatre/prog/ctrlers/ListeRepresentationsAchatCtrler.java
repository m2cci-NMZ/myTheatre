 ...
 */
@WebServlet(name = "ListeRepresentationsAchatCtrler", urlPatterns = {"/ListeRepresentationsAchatCtrler"})
public class ListeRepresentationsAchatCtrler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Representation> representations = ProgDAO.toutesRepresentations(ds);
            // on place cette liste comme attribut de la requête pour que la vue puisse afficher les spectacles
            request.setAttribute("spectacles", representations);
            // redirection vers la vue
            request.getRequestDispatcher("/WEB-INF/choixRepresentationAchat.jsp").forward(request, response);
